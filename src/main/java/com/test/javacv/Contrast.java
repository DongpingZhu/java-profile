...
public class Contrast {
    public static void main(String[] args) {
         ...
         */
        Mat image = imread("src/main/resources/opencv-data/5.jpg");
...
//        transformation_1(image);
     ...
     * @param image
     */
    public static Mat transformation_1(Mat image) {
...
//                    pixelArr[0] = (int)(i0*alpha+bate);//B
//                    pixelArr[1] = (int)(i1*alpha+bate);//G
//                    pixelArr[2] = (int)(i2*alpha+bate);//R
//                    indexer.put(i,j,pixelArr);
//
//                } else {//2 图片为单通道即灰度图
...
//        }
     ...
     * @param image
     */
    public static Mat transformation_2(Mat image) {
